...
switch($today) {
        ...
        case 'Saturday' :
            $day = '<h2>If you aren\'t first, you\'re last!</h2>';
            $pic = 'bunny.jpg';
            $alt = 'Saturday';
        ...
        case 'Tuesday' :
            $day = '<h2>We\'ve all got a journey!</h2>';
            $pic = 'butterfly.webp';
            $alt = 'Tuesday';
        ...
        case 'Wednesday' :
            $day = '<h2>Stand back up, you\'re halfway there!</h2>';
            $pic = 'bear.jpg';
            $alt = 'Wednesday';
        ...
        case 'Thursday' :
            $day = '<h2>It\'s almost the end of the week...</h2>';
            $pic = 'fox.jpg';
            $alt = 'Thursday';
