...
<body>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (isset($_POST['name'],
            ...
            <div class="box">
            <h2>Hello,  '.$name.'</h2>
            <p>You now have <b> $'.number_format($dollars, 2).' American dollars</b> and we will be emailing you at <b>'.$email.'</b> with your information, as well as depositing your funds at '.$bank.'!</p>
            </div>
            ';
            }
        }
