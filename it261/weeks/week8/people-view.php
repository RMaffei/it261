...
if (mysqli_num_rows($result) > 0) {
	while ($row = mysqli_fetch_assoc($result)) {
		...
		$email_name = stripcslashes($row['email_name']);
		$birthdate = stripcslashes($row['birthdate']);
		$occupation = stripcslashes($row['blurb']);
...
<div id="wrapper">
	<main>
		...
		<ul>
			...
			<li><b>First Name: </b>' . $last_name . '</li>
			<li><b>First Name: </b>' . $email . '</li>
			<li><b>First Name: </b>' . $birthdate . '</li>
			<li><b>First Name: </b>' . $occupation . '</li>
			<li>
			<p>' . $details . '</p>
			</li>
			';
